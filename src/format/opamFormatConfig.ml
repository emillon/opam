...
type t = { strict : bool; skip_version_checks : bool; all_parens : bool }

type 'a options_fun =
  ?strict:bool -> ?skip_version_checks:bool -> ?all_parens:bool -> 'a

let default =
  { strict = false; skip_version_checks = false; all_parens = false }

let setk k t ?strict ?skip_version_checks ?all_parens =
